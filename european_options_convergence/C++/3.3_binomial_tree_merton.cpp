...
PYBIND11_MODULE(merton_binomial, m)
{
    m.doc() = "Merton dividend-adjusted binomial tree pricing engine";
    ...
    m.def("call",
        [](double spot, double strike, double rate, double dividend, double volatility, double maturity, int N)
        {
            ...
            return binomialTreeMertonCall(option, N);
        },
        py::arg("spot"),
        py::arg("strike"),
        py::arg("rate"),
    ...
    m.def("put",
        ...
        {
            OptionDataMerton option {spot, strike, rate, dividend, volatility, maturity};
            return binomialTreeMertonPut(option, N);
        },
        py::arg("spot"),
        py::arg("strike"),
        py::arg("rate"),
